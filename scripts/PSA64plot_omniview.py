...
papercal_data, _, _, _ = omni.importuvs(paper_uvfiles, wantpols, timingTolerance=100)
omnical_data, _, _, _ = omni.importuvs(omni_uvfiles, wantpols, timingTolerance=100)
