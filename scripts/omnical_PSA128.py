...
o.add_option('--flagsigma', action = 'store', type = 'float', default = 3, help = 'Number of sigmas to flag on chi^2 distribution. 4 sigma by default.')
...
o.add_option('--flagf', action = 'store', type = 'int', default = 99999, help = 'Number of frequency slices to run the minimum filter when flagging. 4 by default.')
