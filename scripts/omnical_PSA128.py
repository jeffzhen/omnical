...
o.add_option('--flag', action = 'store', type = 'float', default = .5, help = 'relative flag threshold from 0 to 1. Recommend .3 on compressed data and .1 on raw data.')
...
for p, pol in zip(range(len(data)), wantpols.keys()):
    ...
    flags[pol] = calibrators[pol].flag(thresh = flag_thresh)
